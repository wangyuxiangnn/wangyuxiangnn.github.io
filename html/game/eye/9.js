...
var init = function() {
	...
	imageSprite.src = "/html/game/eye/2000-5.png";
	play68_init();
	welcomeView()
};
...
var gameView = function() {
	...
	var A = function() {
		...
		r.style.display = "block";
		 ...
		 i.start();
		r.innerHTML = "成绩："+ --levelCount +"，游戏结束";
		setTimeout(function() {
...
if (typeof StartGame == 'function') {
  ...
  function shareFriend() {
	...
	function addShareWX() {
		...
		n.src = "/html/game/eye/2000-4.png";
		n.id = "share-wx-img";
	...
	false); (function() {
		...
		if (!isMobile()) return;
		var e = document.createElement("div");
		e.style.cssText = "position:absolute;left:0;top:0;background-size: 50%;width:" + window.innerWidth + "px;height:" + Math.max(window.innerHeight, window.document.documentElement.offsetHeight) + "px";
		...
		t.style.cssText = "position:absolute;left:0;top:0;background-size: 50%;";
